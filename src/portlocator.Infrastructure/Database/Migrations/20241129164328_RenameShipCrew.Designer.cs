...
namespace portlocator.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241129164328_RenameShipCrew")]
    partial class RenameShipCrew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("portlocator.Domain.ShipAssignments.ShipAssignment", b =>
                {
                    ...
                    b.HasKey("UserId", "ShipId")
                        .HasName("pk_ship_assignments");

                    b.HasIndex("ShipId")
                        .HasDatabaseName("ix_ship_assignments_ship_id");

                    b.ToTable("ship_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("portlocator.Domain.ShipAssignments.ShipAssignment", b =>
                {
                    b.HasOne("portlocator.Domain.Ships.Ship", "Ship")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ship_assignments_ships_ship_id");
                    ...
                    b.HasOne("portlocator.Domain.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ship_assignments_users_user_id");
